      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">KukuSoko</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/privacy" className="text-gray-200 hover:text-accent transition-colors">Privacy Policy</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:okothroni863@gmail.com" className="text-gray-200 hover:text-accent transition-colors">okothroni863@gmail.com</a>
              </li>
              <li className="flex items-center space-x-2">
